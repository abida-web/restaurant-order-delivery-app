...
// Type definitions (same as above)
interface MenuItem {
  id: string;
  name: string;
  price?: number;
...
const Preparing: React.FC<PreparingProps> = ({ orders, onOrderUpdate }) => {
  ...
  return (
    <div className="flex flex-col space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-blue-500">Preparing Orders</h1>
